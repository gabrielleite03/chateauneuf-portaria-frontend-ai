param(
  ...
  [string]$FrontendImage = "gabrielleite03/chateauneuf-portaria-frontend:2026.07.27.1",
  [string]$BackendImage = "gabrielleite03/chateauneuf-portaria-backend:2026.07.27.1",
