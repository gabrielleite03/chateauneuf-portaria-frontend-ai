param(
  ...
  [string]$FrontendImage = "gabrielleite03/chateauneuf-portaria-frontend:2026.08.08.2",
  [string]$BackendImage = "gabrielleite03/chateauneuf-portaria-backend:2026.08.08.2",
